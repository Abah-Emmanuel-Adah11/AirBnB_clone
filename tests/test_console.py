#!/usr/bin/python3
"""This defines unittests for the console.py.
...
class TestHBNBCommand_prompting(unittest.TestCase):
    """Unittests tests prompting of the HBNB command interpreter."""
...
class TestHBNBCommand_help(unittest.TestCase):
    """Unittests tests help messages of the HBNB command interpreter."""
...
class TestHBNBCommand_exit(unittest.TestCase):
    """Unittests tests exiting from the HBNB command interpreter."""
...
class TestHBNBCommand_show(unittest.TestCase):
    """Unittests tests show from the HBNB command interpreter"""
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """Unittests tests destroy from the HBNB command interpreter."""
...
class TestHBNBCommand_all(unittest.TestCase):
    """Unittests tests all of the HBNB command interpreter."""
...
class TestHBNBCommand_update(unittest.TestCase):
    """Unittests the tests update from the HBNB command interpreter."""
...
class TestHBNBCommand_count(unittest.TestCase):
    """Unittests tests count method of HBNB comand interpreter."""
