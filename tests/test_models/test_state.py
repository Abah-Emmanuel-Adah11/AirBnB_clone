#!/usr/bin/python3
"""This defines unittests for the models/state.py.
...
class TestState_instantiation(unittest.TestCase):
    """Unittests tests instantiation of the State class."""
...
class TestState_save(unittest.TestCase):
    """Unittests tests save method of the State class."""
...
class TestState_to_dict(unittest.TestCase):
    """Unittests tests to_dict method of the State class."""
