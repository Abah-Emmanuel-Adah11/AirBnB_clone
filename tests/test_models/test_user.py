#!/usr/bin/python3
"""This defines unittests for the models/user.py.
...
class TestUser_instantiation(unittest.TestCase):
    """Unittests tests instantiation of the User class."""
...
class TestUser_save(unittest.TestCase):
    """Unittests tests save method of the  class."""
...
class TestUser_to_dict(unittest.TestCase):
    """Unittests tests to_dict method of the User class."""
