#!/usr/bin/python3
"""This defines unittests for the models/place.py.
...
class TestPlace_instantiation(unittest.TestCase):
    """Unittests tests instantiation of the Place class."""
...
class TestPlace_save(unittest.TestCase):
    """Unittests tests save method of the Place class."""
...
class TestPlace_to_dict(unittest.TestCase):
    """Unittests tests to_dict method of the Place class."""
