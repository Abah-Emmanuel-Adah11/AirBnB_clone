#!/usr/bin/python3
"""This defines unittests for the models/city.py.
...
class TestCity_instantiation(unittest.TestCase):
    """Unittests tests instantiation of the City class."""
...
class TestCity_save(unittest.TestCase):
    """Unittests tests save method of the City class."""
...
class TestCity_to_dict(unittest.TestCase):
    """Unittests tests to_dict method of the City class."""
