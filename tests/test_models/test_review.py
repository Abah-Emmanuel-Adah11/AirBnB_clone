#!/usr/bin/python3
"""This defines unittests for the models/review.py.
...
class TestReview_instantiation(unittest.TestCase):
    """Unittests tests instantiation of the Review class."""
...
class TestReview_save(unittest.TestCase):
    """Unittests tests save method of the Review class."""
...
class TestReview_to_dict(unittest.TestCase):
    """Unittests tests to_dict method of the Review class."""
